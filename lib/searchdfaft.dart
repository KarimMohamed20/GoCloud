...
class DropDownListSearch extends StatefulWidget {
  @override
  SearchPage createState() => SearchPage();
}

class SearchPage extends State<DropDownListSearch> {
  ...
  Widget build(BuildContext context) {
    ...
    final governeomentdrop = Container(
        ...
        child: new DropdownButton<int>(
            ...
            iconSize: 50.0,
            hint: Text('ALL', style: TextStyle(color: Colors.green,fontWeight: FontWeight.bold ,fontSize: 17.0)),
...
//print(districtchanged);
            ...
            items: _Governorate_data.map((governorate value2) {
              return new DropdownMenuItem<int>(
                  value: value2.id, child: new Text(value2.name_ar,style:TextStyle(
                  color: Colors.green,
    ...
    final Districtdrop = Container(
      ...
      child: new DropdownButton<int>(
          ...
          iconSize: 50.0,
          hint: Text('ALL', style: TextStyle(color: Colors.green,fontSize: 17.0)),
...
//              districtchanged = null;
          ...
          items: districtsOUT.map((District vall2) {
            return new DropdownMenuItem<int>(
                value: vall2.id, child: new Text(vall2.name_ar,style:TextStyle(
                color: Colors.green,
                fontWeight: FontWeight.bold,
                fontSize: 17.0
...
//*******************************************************************
    ...
    final SpecialTypes = Container(
        ...
        child: new DropdownButton<int>(
            ...
            iconSize: 50.0,
            hint: Text('ALL', style: TextStyle( fontSize: 17.0 ,fontWeight: FontWeight.bold  , color: Colors.green)),
            ...
            items: _SpecialType_data.map((specialType va2) {
              ...
              return new DropdownMenuItem<int>(
                  value: va2.st_gccode, child: new Text(va2.name,style:TextStyle(
                  color: Colors.green,
                  fontWeight: FontWeight.bold,
                  fontSize: 17.0
              ),)
    ...
    final  Specialitydrop= Container(
      ...
      child: new DropdownButton<int>(
          ...
          hint: Text('ALL',maxLines: 2, style: TextStyle(color: Colors.green,fontSize: 17.0)),
...
//              districtchanged = null;
          ...
          items: specialityOUT.map((speciality vall2) {
            return new DropdownMenuItem<int>(
                ...
                value: vall2.st_gccode ,child: new Text(vall2.name,style:TextStyle(
