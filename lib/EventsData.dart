...
import 'package:gocloud/PillReminder.dart';
import 'package:gocloud/events.dart';
...
class _CalendarEventsPageState extends State<CalendarEventsPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return new Scaffold(
      appBar: new AppBar(title: new Text('Active Events'),backgroundColor: Color.fromRGBO(25, 27, 76, 1),),
      body: Container(
        width: MediaQuery.of(context).size.width,
        height: MediaQuery.of(context).size.height,
        decoration: BoxDecoration(
            image:
                DecorationImage(image: AssetImage('assets/background_al.png'),
                fit: BoxFit.fill
                )),
